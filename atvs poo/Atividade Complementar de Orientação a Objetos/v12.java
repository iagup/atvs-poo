...
public class Cliente implements Autenticavel{
    ...
    public class Sistema{
        ...
        public String getValorByIndice(int indice{
            if(indice >= 0 && indice < valores.length){
                return valores[indice];
            }

            throws new ValorIncorretoException("Valor incorreto para o indice");
        }

        public static void main(String[] args){

            Sistema sistema = new Sistema();
            sistema.getValorByIndice(10);

            try{
                String valorByIndice sistema.getValorByIndice(10);
